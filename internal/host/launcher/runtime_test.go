...
func TestSubtractEndpointListRemovesDeniedEndpoints(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:  "leading-zero port and compressed IPv6 match",
			allow: "chatgpt.com:443 [2001:db8::1]:443 github.com:443",
			deny:  "chatgpt.com:0443 [2001:0db8:0000::1]:443",
			want:  "github.com:443",
		},
		{
			name:  "trailing-dot FQDN match",
