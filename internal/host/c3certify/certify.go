...
func (c *certifier) gitCommand(ctx context.Context, dir string, args ...string) ([]byte, error) {
	safeArgs := []string{"--no-replace-objects", "-c", "core.hooksPath=/dev/null", "-c", "core.fsmonitor=false", "-c", "core.fileMode=true", "-c", "core.symlinks=true", "-c", "core.trustctime=true", "-c", "core.checkStat=default", "-c", "diff.external=", "-c", "color.ui=false"}
