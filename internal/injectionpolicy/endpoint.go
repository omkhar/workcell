...
// validate_endpoint (lines ~191-226) byte-for-byte so every injection-policy
// engine (internal/authpolicy validate/show, internal/authresolve, and
// internal/injection render) accepts exactly the same egress-endpoint grammar
// the enforcement helper accepts.
var (
