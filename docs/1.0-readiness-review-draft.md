...
- **Preview-only, launch blocked:**
  ...
  - `macos/arm64/local_vm/apple-container/per-session-vm` — the C1 evaluation
    ...
    1.0; Colima stays the default and the only option below macOS 26.
...
- [ ] **Boundary assurance items** A1/A2/A3/A4/A5/A6 landed; third-party audit
      scheduled or dispositioned (B7) (criterion 2).
